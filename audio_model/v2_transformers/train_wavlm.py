"""
Phase 2C - Train WavLM-base-plus for 8-way speech emotion classification.
...
from transformers import (
    Wav2Vec2FeatureExtractor,         # WavLM uses the same feature extractor
...
OUT_DIR = HERE / "saved_models" / "wavlm"
